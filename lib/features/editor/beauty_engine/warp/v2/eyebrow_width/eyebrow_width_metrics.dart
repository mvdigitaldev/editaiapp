...
class EyebrowWidthRegionStats {
  const EyebrowWidthRegionStats({
  ...
  static const zero = EyebrowWidthRegionStats(
    pixelCount: 0,
    maxAbs: 0,
    meanAbs: 0,
    p95Abs: 0,
...
/// Métricas do Eyebrow Width. Não altera [FieldMetrics] (contrato Jaw).
class EyebrowWidthFieldMetrics {
  const EyebrowWidthFieldMetrics({
  ...
  final EyebrowWidthRegionStats eyes;
  final EyebrowWidthRegionStats nose;
  final EyebrowWidthRegionStats mouth;
  final EyebrowWidthRegionStats hairline;
  final EyebrowWidthRegionStats browActive;

  /// Arco sobe e base desce: a ilha abre.
  bool get browsThicken =>
      dyAtPrimaryLeft < -1e-6 &&
      dyAtPrimaryRight < -1e-6 &&
      dyAtLowerLeft > 1e-6 &&
      dyAtLowerRight > 1e-6;

  /// Arco desce e base sobe: a ilha fecha.
  bool get browsThin =>
      dyAtPrimaryLeft > 1e-6 &&
      dyAtPrimaryRight > 1e-6 &&
      dyAtLowerLeft < -1e-6 &&
  ...
  static const skipped = EyebrowWidthFieldMetrics(
    faceWidth: 0,
    amplitude: 0,
    influenceMax: 0,
    ...
    absAtHairline: 0,
    eyes: EyebrowWidthRegionStats.zero,
    nose: EyebrowWidthRegionStats.zero,
    mouth: EyebrowWidthRegionStats.zero,
    hairline: EyebrowWidthRegionStats.zero,
    browActive: EyebrowWidthRegionStats.zero,
  );
  ...
  static EyebrowWidthFieldMetrics compute({
    ...
    return EyebrowWidthFieldMetrics(
      faceWidth: faceWidth,
      amplitude: amplitude,
      influenceMax: influenceMax,
  ...
  static EyebrowWidthRegionStats statsFor(
    ...
    if (values.isEmpty) {
      return EyebrowWidthRegionStats.zero;
    }
    return EyebrowWidthRegionStats(
