...
class VShapeRegionStats {
  const VShapeRegionStats({
  ...
  static const zero = VShapeRegionStats(
    pixelCount: 0,
    maxAbs: 0,
    meanAbs: 0,
    p95Abs: 0,
...
/// Métricas do V Shape. Não altera [FieldMetrics] (contrato Jaw).
class VShapeFieldMetrics {
  const VShapeFieldMetrics({
    required this.faceWidth,
    required this.vShapeAmplitude,
    ...
    required this.absAtInnerLeft,
    required this.absAtInnerRight,
  ...
  final double absAtInnerLeft;
  final double absAtInnerRight;
  final double absAtGonionLeft;
  final double absAtGonionRight;
  final VShapeRegionStats eyes;
  final VShapeRegionStats brows;
  final VShapeRegionStats nose;
  final VShapeRegionStats mouth;
  final VShapeRegionStats faceCenter;
  final VShapeRegionStats ears;
  final VShapeRegionStats jawDomain;
  final VShapeRegionStats chinTip;
  final VShapeRegionStats chinActive;

  bool get vShapeSharpens => chinWidthAfter < chinWidthBefore - 1e-6;

  bool get vShapeSquares => chinWidthAfter > chinWidthBefore + 1e-6;

  static const skipped = VShapeFieldMetrics(
    faceWidth: 0,
    vShapeAmplitude: 0,
    influenceMax: 0,
    ...
    absAtGonionLeft: 0,
    absAtGonionRight: 0,
    eyes: VShapeRegionStats.zero,
    brows: VShapeRegionStats.zero,
    nose: VShapeRegionStats.zero,
    mouth: VShapeRegionStats.zero,
    faceCenter: VShapeRegionStats.zero,
    ears: VShapeRegionStats.zero,
    jawDomain: VShapeRegionStats.zero,
    chinTip: VShapeRegionStats.zero,
    chinActive: VShapeRegionStats.zero,
  );

  Map<String, Object> toJson() => {
        'faceWidth': faceWidth,
        'vShapeAmplitude': vShapeAmplitude,
        ...
        'vShapeSharpens': vShapeSharpens,
        'vShapeSquares': vShapeSquares,
        ...
        'absAtInnerLeft': absAtInnerLeft,
        'absAtInnerRight': absAtInnerRight,
  ...
  static VShapeFieldMetrics compute({
    required DisplacementField field,
    required VShapeMasks masks,
    required List<Offset?> px,
    required double faceWidth,
    required double vShapeAmplitude,
    ...
    return VShapeFieldMetrics(
      ...
      absAtInnerLeft: _absAt(field, px, innerLeft),
      absAtInnerRight: _absAt(field, px, innerRight),
  ...
  static VShapeRegionStats statsFor(DisplacementField field, Uint8List mask) {
    final values = <double>[];
    var sum = 0.0;
    var maxAbs = 0.0;
    ...
    if (values.isEmpty) {
      return VShapeRegionStats.zero;
    }
    return VShapeRegionStats(
