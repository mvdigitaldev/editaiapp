...
/// Máscaras do Jaw Angle. Não altera [RegionMasks] (contrato Jaw).
class JawAngleMasks {
  JawAngleMasks({
    required this.width,
  ...
  static JawAngleMasks build({
    ...
    final earRadius = 0.05 * faceWidth;
    ...
    final jawRadius = 0.045 * faceWidth;
    ...
    final tipRadius = 0.022 * faceWidth;
