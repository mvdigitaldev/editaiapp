...
class _BeautyEditorPageState extends ConsumerState<BeautyEditorPage> {
  ...
  Future<void> _pickImage() async {
    ...
    await _applyLoadedBytes(await file.readAsBytes(), path: file.path);
  }
  ...
  Future<void> _ensureLandmarks() async {
    ...
    controller.personMaskThrottle.reset();
  ...
  String? _firstActiveFaceWarpKey() {
    ...
    if ((_params['eyebrow_height'] ?? 0).abs() > 0.001 ||
        (_params['eyebrow_height_left'] ?? 0).abs() > 0.001 ||
    ...
    if ((_params['eyebrow_end'] ?? 0).abs() > 0.001 ||
        (_params['eyebrow_end_left'] ?? 0).abs() > 0.001 ||
                            ...
                            child: _brushMode
                                ...
                                : Stack(
                                    ...
                                    children: [
                                      ...
                                      // if (kDebugMode &&
                                      //     FaceWarpV3Config
                                      //         .extendedRoiDebugOverlay &&
                                      //     !_showOriginal &&
                                      //     preview != null)
                                      //   _extendedRoiOverlay(fitted),
                                    ],
                                  ),
                          ),
                        );
